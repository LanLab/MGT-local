import re
import importlib
# from Salmonella.models import Isolate, View_apcc, Location, Isolation, Tables_cc, Tables_ap


def columns(isAuth, org):
	Isolate, View_apcc, Location, Isolation, Tables_cc, Tables_ap = getModels(org)
	list_isoAndMeta = list()

	list_isoAndMeta = addColsInfoToList(list_isoAndMeta, Isolate._meta.fields, 'Isolate', isAuth, org)
	list_isoAndMeta = addColsInfoToList(list_isoAndMeta, Location._meta.fields, 'Location', isAuth, org)
	list_isoAndMeta = addColsInfoToList(list_isoAndMeta, Isolation._meta.fields, 'Isolation', isAuth, org)
...
def addColsInfoToList(list_, theFields, group, isAuth, org):
	Isolate, View_apcc, Location, Isolation, Tables_cc, Tables_ap = getModels(org)
...
def getApColsForDisplay(db_cols, apCols, prependStart, prependEnd, org):
	Isolate, View_apcc, Location, Isolation, Tables_cc, Tables_ap = getModels(org)
	# print (db_cols)
...
def getModels(org):
    ...
    return Isolate, View_apcc, Location, Isolation, Tables_cc, Tables_ap