import json
# from Salmonella.models import Project
import importlib
...
def convertToArrs_searchIsoDetail(searchAp, searchCcEpi, searchLocs, searchIsln, searchProj, searchIso, username, org):

	Project = importlib.import_module(f'{org}.models').Project
	...
	if searchProj:
		try:
			...
			routeToRightRawQFn.isProjectByUser(projectId, username, org)
		except:
