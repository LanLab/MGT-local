...
def makeCsv_andSendToMr(isolates, isAuth, list_colsInfo):

	geolocator = Nominatim(user_agent='mgtdb.unsw.edu.au') 
	outStr = makeCsv_microreact(isolates, isAuth, list_colsInfo, geolocator)
...
def makeCsv_microreact(isolates, isAuth, list_colsInfo, geolocator):
	"""
	...
	(header, colNums, list_apTns, list_ccTns, dict_apCols, dict_ccCols, colNums_md, col_serverStatus, col_assignStatus, col_country) = extractTheHeader(list_colsInfo)
