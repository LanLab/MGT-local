...
from Blankdb.views.FuncsAuxAndDb import rawQueries_graph as rqGraph
from django.http import Http404
import sys



def getDataFromRightFn(arr_ap, arr_cc, arr_epi, arr_loc, arr_isln, arr_iso, username, isExactProj, projIdToExcl, searchType):
	...
	(isolates, columns) = rqGraph.get_timeOrLoc_StCountData(mgtIds, locIds, islnIds, isoSearchStr, searchedProjIds, userProjIds, isExactProj, projIdToExcl)
