from Blankdb.views.FuncsAuxAndDb import getPoolOfCcMergeIds,rawQueries
from time import sleep as sl
from collections import OrderedDict
import time


def get_merge_dict(list_colsInfo):
    merge_dicts = {}
    ...
    for coldict in list_colsInfo:
        ...
        if colname.startswith("cc") and "merge" not in colname and colname != "cc2_1":
            ...
            querystring = """SELECT "identifier","merge_id_id" FROM "Blankdb_{}"; """.format(colname)

            (data, columns) = rawQueries.executeQuery_table(querystring)
...
def get_merges(list_colsInfo,isolates):
    """
    ...
    merge_dicts = get_merge_dict(list_colsInfo)
