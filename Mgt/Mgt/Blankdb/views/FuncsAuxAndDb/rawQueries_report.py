...
from Blankdb.models import Tables_ap, Tables_cc, Project

def getDataForReport(username, selCountry, selProj, isAuth, yearStart, yearEnd):
	...
	res = getData(year_10Ago, now, country_name, selProj, userProjIds, isAuth, list_tabAps, list_tabCcs)
...
def getData(year_10Ago, yearCurr, selCountry, selProj, userProjIds, isAuth, list_tabAps, list_tabCcs):
	...
	queryStr = queryStr + " from " + rawQueries.db_isolate + ", " + rawQueries.db_view_apcc + ", " + rawQueries.db_isolation + ", " + rawQueries.db_location
	...
	queryStr = queryStr + addWhereIsAuthPart_1(isAuth, selProj, userProjIds)
...
def addWhereIsAuthPart_1(isAuth, selProj, userProjIds):
	queryStr = ''
