...
def addTheHstMatrix(projectPath, projectName, appName, mgtlist,settingpath,levels):
		...
		readFileAndAdd(projectPath, appName, appClass, mgtlist,levels)

################################# AUX

def readFileAndAdd(projectPath, appName, appClass, mgtlist,levels):
	...
	# 			arr = line.split("\t")
				...
				# if isHeader == True:
	arrhead = ["Lanlab","NCBI","Strain","AssignmentStatus"]	+ levels
