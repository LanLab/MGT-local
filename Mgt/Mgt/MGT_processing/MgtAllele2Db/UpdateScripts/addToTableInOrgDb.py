...
def addIsolation(appClass, source, type, host, hostDisease, date, year, month):
	i = appClass.models.Isolation(source=source, type=type, host=host, disease=hostDisease, date=date, year=year, month=month)
...
def addIsolate(appClass, projObj, isolateId, server_status, priv_status, file_forward, file_reverse, locObj, isolnObj, fkObj, mgt1, serovar):

	i = appClass.models.Isolate(project=projObj, identifier=isolateId, server_status=server_status, privacy_status=priv_status, file_forward=file_forward, file_reverse=file_reverse, location=locObj, isolation=isolnObj, mgt1=mgt1, serovar=serovar)
...
def addTablesCc(orgClass, schObj, tn, tableNum, displayOrder, displayName,maxDiff):
	try:
		tnObj = orgClass.models.Tables_cc(scheme=schObj, table_name=tn, display_table=tableNum,display_order=displayOrder, display_name=displayName, differences_max=maxDiff)
